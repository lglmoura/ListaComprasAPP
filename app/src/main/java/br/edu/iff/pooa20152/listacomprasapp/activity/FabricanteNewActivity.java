...
public class FabricanteNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fabricante fabricante = (Fabricante)args.getParcelable("fabricante");
    ...
    private void setValores(Fabricante fabricante) {

        etCodigo.setText(fabricante.getId().toString());
        etNome.setText(fabricante.getNome());
        etEndereco.setText(fabricante.getEndereco());
        etNumero.setText(fabricante.getNumero());
        etCnpj.setText(fabricante.getCnpj());
    ...
    public class FabricanteTask extends AsyncTask<String, String, Fabricante> {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(FabricanteNewActivity.this);
            dialog.show();
        }
